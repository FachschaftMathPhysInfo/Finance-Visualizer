    ...
    },
 {
    ...
    },
  {
    ...
    },
    {
      'id': '0.8.2',
      'parent': '0.8',
      'title': 'Master-Ersti-Veranstaltung SoSe 19',
      'name': 'Master-Ersti-Veranstaltung SoSe 19',
      'text': 'In den Masterstudiengängen an unseren Fakultäten ist der Anteil internationaler Studierender signifikant höher als in den entsprechenden Bachelorstudiengängen; weiterhin kommen auch viele Studierende von einem Bachelor an einer anderen Hochschule neu nach Heidelberg. Da viele dieser internationalen Studierenden sich noch nicht lange in Deutschland aufhalten, fehlt ihnen oft entscheidendes Wissen über Formalia, Prüfungsordnungen, Lehrkonzepte und Fächerkulturen an der Universität, das ihnen bei den Einführungsveranstaltungen der Fakultäten auch meist nicht im ausreichendem Maße vermittelt wird. Deshalb bietet unsere Fachschaft jedes Semester Einführungsveranstaltungen für die Masterstudiengänge an, bei denen die Anwesenden Masterstudis über einige der oben genannten Themen aufgeklärt werden. Weiterhin bietet es ihnen die Gelegenheit sich untereinander und mit den nicht- internationalen Studierenden auszutauschen und zu vernetzen. Bei der Veranstaltung wird Verpflegung in Form von Keksen, Säften, Kaffee und Kuchen kostenlos zur Verfügung gestellt.',
      'value': 78.67,
    },
    {
      'id': '0.8.3',
      'parent': '0.8',
      'title': 'Master-Ersti-Veranstaltung WiSe 19/20',
      'name': 'Master-Ersti-Veranstaltung WiSe 19/20',
      'text': 'In den Masterstudiengängen an unseren Fakultäten ist der Anteil internationaler Studierender signifikant höher als in den entsprechenden Bachelorstudiengängen; weiterhin kommen auch viele Studierende von einem Bachelor an einer anderen Hochschule neu nach Heidelberg. Da viele dieser internationalen Studierenden sich noch nicht lange in Deutschland aufhalten, fehlt ihnen oft entscheidendes Wissen über Formalia, Prüfungsordnungen, Lehrkonzepte und Fächerkulturen an der Universität, das ihnen bei den Einführungsveranstaltungen der Fakultäten auch meist nicht im ausreichendem Maße vermittelt wird. Deshalb bietet unsere Fachschaft jedes Semester Einführungsveranstaltungen für die Masterstudiengänge an, bei denen die Anwesenden Masterstudis über einige der oben genannten Themen aufgeklärt werden. Weiterhin bietet es ihnen die Gelegenheit sich untereinander und mit den nicht- internationalen Studierenden auszutauschen und zu vernetzen. Bei der Veranstaltung wird Verpflegung in Form von Keksen, Säften, Kaffee und Kuchen kostenlos zur Verfügung gestellt.',
      'value': 111.67,
    },
    {
